...
module.exports = {
  ...
  getTargetGroupLogicalId(functionName) {
    return `${this.getNormalizedFunctionName(functionName)}TargetGroup`;
  },
  getListenerLogicalId(functionName, idx) {
    return `${this.getNormalizedFunctionName(functionName)}Listener${idx}`;
  },
  ...
  getAlbPermissionLogicalId(functionName) {
